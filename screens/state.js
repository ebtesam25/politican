        ...
        onLongPress={(e) => this.setState({ amarker: [{ latlng: e.nativeEvent.coordinate }] })}>
          {
              ...
              this.state.markers.map((marker, j) => (
                <Marker key={j} coordinate={{latitude:parseFloat(marker.lat),longitude:parseFloat(marker.lon)}} title={marker.state} description={"A:"+marker.quakerisk+","+"B:"+marker.floodrisk +","+"C:"+marker.stormrisk+","+"D:"+marker.firerisk} >
