    ...
    return (
      ...
      <View style={{backgroundColor:'#FFF', flex:1}}>
        ...
        <View style={{backgroundColor:'#6B92D6', height:550, position:'absolute',zIndex:1, width:'100%'}}>
            <Text style={{fontSize:20,fontFamily:'Avenir', color:'#DDFBD2', marginTop:'10%', marginLeft:'10%'}}>Polling Station</Text>
        ...
        <Text style={{height:40, width:150, fontFamily:'Avenir', fontSize:30, position:'absolute', top:'10%', left:'20%', color:valueColorE}}>{this.state.quake}</Text><Image source={Eq} style={{height:40, width:40, resizeMode:'contain', position:'absolute', top:'20%', left:'20%'}}></Image><Text style={{height:40, width:150, fontFamily:'Avenir', fontSize:20, position:'absolute', top:'30%', left:'10%', color:'#6B92D6'}}>POLL</Text>
        <Text style={{height:40, width:150, fontFamily:'Avenir', fontSize:30, position:'absolute', top:'40%', left:'20%', color:valueColorF}}>{this.state.fire}</Text><Image source={Fire} style={{height:40, width:40, resizeMode:'contain', position:'absolute', top:'50%', left:'20%'}}></Image><Text style={{height:40, width:150, fontFamily:'Avenir', fontSize:20, position:'absolute', top:'60%', left:'20%', color:'#6B92D6'}}>PEOPLE</Text>
        <Text style={{height:40, width:150, fontFamily:'Avenir', fontSize:30, position:'absolute', top:'10%', right:'-7%', color:valueColorFl}}>{this.state.flood}</Text><Image source={Flood} style={{height:40, width:40, resizeMode:'contain', position:'absolute', top:'20%', right:'20%'}}></Image><Text style={{height:40, width:150, fontFamily:'Avenir', fontSize:20, position:'absolute', top:'30%', right:'-5%', color:'#6B92D6'}}>CHECKIN</Text>
        <Text style={{height:40, width:150, fontFamily:'Avenir', fontSize:30, position:'absolute', top:'40%', right:'-7%', color:valueColorS}}>{this.state.storm}</Text><Image source={Storm} style={{height:40, width:40, resizeMode:'contain', position:'absolute', top:'50%', right:'20%'}}></Image><Text style={{height:40, width:150, fontFamily:'Avenir', fontSize:20, position:'absolute', top:'60%', right:'-5%', color:'#6B92D6'}}>PROFILE</Text>
