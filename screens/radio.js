...
import Rad from '../assets/img/loc.png'
import RadA from '../assets/img/loc.png'
...
export default class Radio extends Component {
  ...
  componentDidMount(){
    fetch('https://us-central1-aiot-fit-xlab.cloudfunctions.net/aa', {
        method: 'GET'
     })
    ...
    return (
      <View style={{backgroundColor:'#FFF', flex:1}}>
        <View style={{backgroundColor:'#D08E2F', height:'100%', position:'absolute',zIndex:1, width:'100%'}}>
            ...
            <Text style={{fontSize:50,fontFamily:'Avenir', color:'#000000', marginTop:'17%', marginLeft:'20%'}}>PolitiCan</Text>
        </View>
